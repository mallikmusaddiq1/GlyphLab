...
async function exportBkm(e) {
    ...
    if ("html" === e) {
        ...
        if (0 === Object.keys(grp.SINGLE || {}).length) delete grp.SINGLE;
        if (0 === Object.keys(grp.COMBINED || {}).length) delete grp.COMBINED;
        if ("json" === e) {
            outStr = "{\n";
